...
var level_display = '-';
if (level_counter == 0) {level_display = 'Ετοιμάσου!'};
if (level_counter == 1) {level_display = 'Βαθμίδα 1'};
if (level_counter == 2) {level_display = 'Βαθμίδα 2'};
if (level_counter == 3) {level_display = 'Βαθμίδα 3'};
if (level_counter == 4) {level_display = 'Πλήρης!'};
